...
module.exports.index = async function(req,res){
    ...
    res.render('home/index',{phim:movies,newOddFilm:newOddFilm,trailer:trailer});
};
...
module.exports.listCategory = async function(req,res){
    ...
    let film =await Phim.find({category:{$elemMatch:{name:category[0].name}}});
...
module.exports.listYear= async function(req,res){
    ...
    console.log(id);
    if(id == "-2014"){
        let film = await Phim.find({year:{$lt:2014}});
